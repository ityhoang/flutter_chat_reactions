...
class ReactionsDialogWidget extends StatefulWidget {
  ...
  const ReactionsDialogWidget({
    ...
    this.paddingItemMenu = EdgeInsets.zero,
  });
  ...
  final EdgeInsetsGeometry paddingItemMenu;
  final Color menuColor;
  final bool isShowReaction;
            ...
            children: [
              ...
              if (widget.isShowMenu) ...[
                ...
                ContextMenuWidget(
                  ...
                  padding: widget.paddingItemMenu,
...
class _Debounce {
  ...
  void run(VoidCallback? action, {Duration duration = const Duration(milliseconds: 200)}) {
